...
#--------------DESCOMPOSICIÓN DE SERIES---------------------
      ...
      flor.stl <- stl(flour.l, s.window = 'period')    
      plot(flor.stl)
      flor.stl
#----------------------------------------------------------
      # 2a alternativa
      flour.dec <- decompose(flour.l)
      plot(flour.dec, col = 'red')      
      
      # Eliminar estacionalidad (ruido)
      flour.season.adjusted <- prices.ts[,1] - flour.dec$seasonal
      plot(flour.season.adjusted)     
